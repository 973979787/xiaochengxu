const app = getApp()
const imageUrl = app.globalData.serviceUrl + app.globalData.apiVersion + '/service/image'
...
Page({
  ...
  downloadAllFromRemote: function () {
    var that = this
    wx.request({
      url: app.globalData.serviceUrl + app.globalData.apiVersion + '/service/image/list',
      method: 'GET',
      success: function (res) {
  ...
  uploadFiles: function () {
    ...
    for (var i = 0; i < this.data.needUploadFiles.length; i++) {
      ...
      wx.uploadFile({
        url: app.globalData.serviceUrl + app.globalData.apiVersion + '/service/image/',
        filePath: file,
        name: 'test',
        success: function (res) {
